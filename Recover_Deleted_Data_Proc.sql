...
-- Modified by: Randi Vertongen
-- Date Created: 15 Oct 2011
-- Modify Date: 09 Aug 2019
-- Version    : 3.1
...
select *,CAST(N'c:\temp\log1.trn' as nvarchar(255)) as LogFileName
INTO #TEMP
from  fn_dump_dblog (NULL, NULL, N'DISK', 1, N'c:\temp\log1.trn',
...
INSERT INTO #TEMP
select * ,CAST(N'c:\temp\log2.trn' as nvarchar(255))
from  fn_dump_dblog (NULL, NULL, N'DISK', 1, N'c:\temp\log2.trn',
DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT,
DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT,
DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT,
DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT,
...
INSERT INTO #TEMP
select * ,CAST(N'c:\temp\log3.trn' as nvarchar(255))
from  fn_dump_dblog (NULL, NULL, N'DISK', 1, N'c:\temp\log3.trn',
DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT,
DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT,
DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT,
DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT,
...
INSERT INTO #TEMP 
select * ,CAST(N'c:\temp\log4.trn' as nvarchar(255))
from  fn_dump_dblog (NULL, NULL, N'DISK', 1, N'c:\temp\log4.trn',
DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT,
DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT,
DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT,
DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT,
...
-----------------------------------------------
-- INSERT AS MANY LOG FILES AS NEEDED HERE --
-----------------------------------------------
...
SET @sql = 'SELECT ' + @FieldName  + ',LogFileName FROM #temp_Data PIVOT (Min([FieldValue]) FOR FieldName IN (' + @FieldName  + ')) AS pvt'

CREATE TABLE  #temp2(Description1 nvarchar(255),val nvarchar(255),LogFileName nvarchar(255))
INSERT INTO #temp2
EXEC sp_executesql @sql

IF EXISTS(SELECT* FROM #temp2 where val = @SearchString)
BEGIN
SELECT* FROM #temp2 
WHERE val = @SearchString
END
DROP TABLE #temp2;
GO
--Execute the procedure like
-- EXEC dbo.Recover_Deleted_Data_Proc  @Database_Name= 'Databasename',@SchemaName_n_TableName= 'schemaname.tablename', @SearchString = 'thevalueinacolumn'
