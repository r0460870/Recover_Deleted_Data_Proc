...
CREATE TABLE #files (ID int IDENTITY, [FileName] varchar(2000));

SET @CMD = 'dir '+@LogBackupFolder+' /b';

insert into #files 
execute xp_cmdshell @CMD

DELETE FROM #files 
WHERE RIGHT(RTRIM([FileName]),3) != 'trn';
...
SET @SQL =
'
select *,CAST(N'''+@LogBackupFolder+@Filename+''' as varchar(4000)) as LogFileName
from  fn_dump_dblog (NULL, NULL, N''DISK'', 1, N'''+@LogBackupFolder+@Filename+''',
